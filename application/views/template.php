...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url(); ?>" class="logo">
      ...
      <span class="logo-mini"><img src="<?php echo base_url(); ?>assets/img/sippla2.png" width="35px"></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">
        <img src="<?php echo base_url(); ?>assets/img/sippla2.png" width="150px">
      ...
      <ul class="nav navbar-nav navbar-left">
          <li class="left-navblock">
              <div class="navbar-brand no-hover" href="<?php echo base_url() ?>">
                  ...
                  &nbsp;<font size="4">Sistem Informasi Paperless Perbendaharaan Lamongan Tahun Anggaran <?php echo $tahun; ?></font>
              </div>
          </li>
      </ul>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo site_url()?>pegawai/profile/<?php echo $id_pegawai ?>" class="btn btn-info btn-flat">Profile</a>
                </div>
