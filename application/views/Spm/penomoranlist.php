                ...
                <div class='box-header'>
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <td style='text-align:center;width:100%'><strong><font size="4">BADAN PENGELOLAAN KEUANGAN DAN ASET DAERAH KABUPATEN LAMONGAN</font><br><font size="3">PENOMORAN SURAT PERINTAH PENCAIRAN DANA (SP2D)</font></strong></td>
                        </tr>
                    </table>
                </div><!-- /.box-header -->
                <div class='box-body'>
                    ...
                    <table class="table table-bordered table-striped table-condensed" id="mytable" style="border-top:1px solid #ddd; border-left:1px solid #ddd; border-right:1px solid #ddd; border-bottom:1px solid #ddd;">
            	       ...
            	       <tbody>
                			...
                			<?php 
                            echo '  ';
                            echo anchor(site_url('spm/cekpenomoransp2d/'.$spm->IdSpm),'<i class="fa fa-check"></i> Cek',array('title'=>'cek','class'=>'btn btn-primary btn-xs')); 
                			?>
                		    </td>
                	        </tr>
                                <?php
