                ...
                <div class="box-body">  
                    ...
                    <tbody>
                            ...
                            <td>
                                <div class="col-sm-8">
                                    <div class="form-group">
                                        <div class="radio">
                                            <label>
                                            <input type="radio" name="StatusAppKasubid" id="StatusAppKasubid1" value="1" onClick="pilih_terima();" checked>
                                            Terima
                                            </label>
                                        </div>
                                            <div class="radio">
                                            <label>
                                            <input type="radio" name="StatusAppKasubid" id="StatusAppKasubid2" value="2" onClick="pilih_tolak();">
                                            Tolak
                                            </label>
                                        </div>
                                    </div>
                        ...
                        <tr id="alasantolak">
                            ...
                            <td>
                                <div class="col-sm-8">
                                    <textarea class="form-control" id="AlasanTolakKasubid" name="AlasanTolakKasubid" placeholder="Jelaskan Alasan Penolakan Pengajuan SPM"></textarea>
                                </div>
                            </td>
                        </tr>
                        <tr>
