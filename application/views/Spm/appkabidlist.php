            	       ...
            	       <tbody>
                            ...
                            foreach ($spm_data as $spm)
                            {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $spm->TanggalAppKasubid ?></td>
                			...
                			<?php 
                            echo '  ';
                            echo anchor(site_url('spm/cekapprovalkabid/'.$spm->IdSpm),'<i class="fa fa-check"></i> Cek',array('title'=>'cek','class'=>'btn btn-primary btn-xs')); 
                			?>
                		    </td>
                	        </tr>
                                <?php
