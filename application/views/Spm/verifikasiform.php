        ...
        <div class="col-md-12">
            <div class='box box-solid'>
                ...
                <div class="box-body">  
                    ...
                    <tbody>
                        <tr>                            
                            <td width="25%" style="padding-left:20px"><label class="col-sm-12 control-label">Keterangan Pengajuan</label></td>
                            <td>
                                <div class="col-sm-12">          
                                    <input type="text" class="form-control" id="Keterangan" name="Keterangan" value="<?php echo $Keterangan; ?>" placeholder="Keterangan Pengajuan"> 
                                    <?php echo form_error('Keterangan') ?>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td width="25%" style="padding-left:20px"><label class="col-sm-12 control-label">Tipe SPM</label></td>
                            <td>
                                <div class="col-sm-8">
                        ...
                        if(!empty($StatusVerifikasi)) { ?>
                            <tr>
                                <td width="25%" style="padding-left:20px"><label class="col-sm-12 control-label">Diterima / Ditolak</label></td>
                                <td>
                                    <div class="col-sm-8">
                                        <div class="form-group">
                                            <div class="radio">
                                                <label>
                                                <input type="radio" name="StatusVerifikasi" <?php if($StatusVerifikasi==1) {echo 'checked'; } ?> id="StatusVerifikasi1" value="1" onChange="pilih_terima();">
                                                Terima
                                                </label>
                                            </div>
                                                <div class="radio">
                                                <label>
                                                <input type="radio" name="StatusVerifikasi" <?php if($StatusVerifikasi==2) {echo 'checked'; } ?> id="StatusVerifikasi2" value="2" onChange="pilih_tolak();">
                                                Tolak
                                                </label>
                                            </div>
                                        </div>
                                ...
                                <td>
                                    <div class="col-sm-8">
                                        <div class="form-group">
                                            <div class="radio">
                                                <label>
                                                <input type="radio" name="StatusVerifikasi" id="StatusVerifikasi1" value="1" onChange="pilih_terima();" checked>
                                                Terima
                                                </label>
                                            </div>
                                                <div class="radio">
                                                <label>
                                                <input type="radio" name="StatusVerifikasi" id="StatusVerifikasi2" value="2" onChange="pilih_tolak();">
                                                Tolak
                                                </label>
                                            </div>
                                        </div>
                        ...
                        ?>
                            <tr id="alasantolak">
                                <td width="25%" style="padding-left:20px"><label class="col-sm-12 control-label">Alasan Ditolak</label></td>
                                <td>
                                    <div class="col-sm-8">
                                        <textarea class="form-control" id="AlasanTolakVer" name="AlasanTolakVer" placeholder="Jelaskan Alasan Penolakan Pengajuan SPM"><?php echo $AlasanTolakVer; ?></textarea>
                                    </div>
                                </td>
                            </tr>
                        <?php 
                        ...
                        ?>
                            <tr id="alasantolak">
                                ...
                                <td>
                                    <div class="col-sm-8">
                                        <textarea class="form-control" id="AlasanTolakVer" name="AlasanTolakVer" placeholder="Jelaskan Alasan Penolakan Pengajuan SPM"></textarea>
                                    </div>
                                </td>
                            </tr>
                        <?php } ?>
...
$(document).ready(function(){
    ...
    /*
    if($("#StatusVerifikasi1").prop("checked", true)) {
        $('#alasantolak').hide();
    } else if($("#StatusVerifikasi2").prop("checked", true)) {
        $('#alasantolak').show();
    }*/

    
    var StatusVerifikasi = $("input[name='StatusVerifikasi']:checked").val();
...
function pilih_terima()
{
    $('#alasantolak').hide();
}

function pilih_tolak()
{
    $('#alasantolak').show();
}
</script>