...
<section class="content-header">
    <h1>&nbsp;</h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Menu Kabid</a></li>
                    ...
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <td style='text-align:center;width:100%'>
                                ...
                                <font size="3">APPROVAL SURAT PERINTAH MEMBAYAR (SPM)</font></strong><br>
                ...
                <div class="box-body"> 
                    ...
                    <tbody>
                            ...
                            <td>
                                <div class="col-sm-8">
                                    <div class="form-group">
                                        <div class="radio">
                                            <label>
                                            <input type="radio" name="StatusAppKabid" id="StatusAppKabid1" value="1" onClick="pilih_terima();" checked>
                                            Terima
                                            </label>
                                        </div>
                                            <div class="radio">
                                            <label>
                                            <input type="radio" name="StatusAppKabid" id="StatusAppKabid2" value="2" onClick="pilih_tolak();">
                                            Tolak
                                            </label>
                                        </div>
                                    </div>
                        ...
                        <tr id="alasantolak">
                            ...
                            <td>
                                <div class="col-sm-8">
                                    <textarea class="form-control" id="AlasanTolakKabid" name="AlasanTolakKabid" placeholder="Jelaskan Alasan Penolakan Pengajuan SPM"></textarea>
                                </div>
                            </td>
                        </tr>
                        <tr>
